export const CARUS = "0xACCB18F3eaad4649a831ce583140C5452E1FAD9c" as const;
export const CARUSABI = [
  {
    inputs: [
      {
...
export const CARUSTOKEN = "0x765de816845861e75a25fca122bb6898b8b1282a" as const;
